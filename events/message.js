...
module.exports = async (client, message) => {
    ...
    let missing = new Discord.RichEmbed()
      .setAuthor("Darky Error","https://cdn.discordapp.com/attachments/701803083629592577/733311080851439636/2Q.png")
      .setTitle("⚠ Error - Missing Features ⚠")
      .setColor(`#FF0062`)
      .setFooter("© Darky | Developed By Darkboy","https://cdn.discordapp.com/attachments/701803083629592577/733311080851439636/2Q.png")
